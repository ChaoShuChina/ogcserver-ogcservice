This project is based on the open source project: mapnik / OGCServer (https://github.com/mapnik/OGCServer), in a open a port and services, can not issue multiple OGC services.
